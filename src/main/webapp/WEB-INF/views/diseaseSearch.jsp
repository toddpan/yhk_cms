...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="#">
				<img src="${rootUrl}resources/admin/layout4/img/logo-slogen.jpg"  height="40px" alt="logo" class="logo-default"/>
			</a>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="tabable tabbable-custom tabbable-noborder tabbable-reversed">
						...
						<div class="tab-content">
							...
							<div  id="tab_0">
								<div class="portlet box blue">
									...
									<div class="portlet-body form" ng-controller="UserCtrl">
										<!-- BEGIN FORM-->

										<form:form id="searchDiseaseExamMappingClient" method="post" action="searchDiseaseExamMappingClient" modelAttribute="disease" class="form-horizontal form-row-seperated">
											<div class="form-body">

												<div class="form-group">
													<label class="col-sm-3 control-label">疾病查询</label>
													<div class="col-sm-4">
														<div class="input-group">



															<input type="text"  class="form-control" id="remote_input"  name="diseaseCode" PLACEHOLDER="Disease code or name"/>


			<span class="input-group-addon">

			<button id="open" class="fa fa-search" type="button"></button>
			</span>
...
<script src="${rootUrl}resources/admin/pages/scripts/form-samples.js"></script>
<link rel="stylesheet" href="${rootUrl}resources/css/jquery.autocomplete.css"/>
