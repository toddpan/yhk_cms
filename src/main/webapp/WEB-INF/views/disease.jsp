				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>用户管理>${userRealname}
							</div>
							<div class="tools">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										...
										<div class="btn-group">
											<button id="searchUserList" onclick="searchResult()" class="btn green">
												决策 	<i class="fa fa-plus"></i>
											</button>
										</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<c:forEach var="obj" items="${examLists}">
										<tr class="odd gradeX">
											<td>
												<input type="checkbox"  name="checkbox" class="checkboxes" value="${obj.examListId}"/>
											</td>
