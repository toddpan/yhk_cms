						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button id="addUser" onclick="addUser()" class="btn green">
												添加用户基础信息	<i class="fa fa-plus"></i>
											</button>
										</div>
										<div class="btn-group">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<c:forEach var="user" items="${listUsers}">
										<tr class="odd gradeX">
											<td>
												<input type="checkbox"  name="checkbox" class="checkboxes" value="${user.userGuid}"/>
											</td>
											<td>
													${user.username}
											</td>
			...
			<script>
				...
				function searchUserList(){
					...
					$('input[name="checkbox"]:checked').each(function(){//遍历每一个名字为interest的复选框，其中选中的执行函数
						location.href="${rootUrl}searchExaminationList/"+$(this).val();
					});
