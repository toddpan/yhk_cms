...
//			// 添加数据库cdruser记录
//			Cdruserinfo cdruserinfoOffLine = new Cdruserinfo();
//			cdruserinfoOffLine.setActiontypeid(Consts.OFFLINE);
//			cdruserinfoOffLine.setTimestamp(new Date());
//			cdruserinfoOffLine.setTempconferenceid(userOfflineMsgResult.getConfID());
//			cdruserinfoOffLine.setTempuserid(userOfflineMsgResult.getUserID());
//			cdruserinfoOffLine.setMsgtimestamp(userOfflineMsgResult.getTimestamp());
//			
//			try {
//				ConferenceBusinessImpl.getCdrUserInfoManager().create(cdruserinfoOffLine);
//				
//			}catch (Exception e) {
//				dealKeysException(e);
//			}
